...
let nameSongs = [
	...
	"MASTERS OF WAR", /*6*/
	"BALLAD OF HOLLIS BROWN", /*7*/
	"WITH GOD ON OUR SIDE", /*8*/
	"SAD-EYED LADY", /*9*/
	"DESOLATION ROW", /*10*/
	"ROSEMARY AND THE JACK OF HEARTS", /*11*/
	"IDIOT WIND", /*12*/
	"TANGLED UP IN BLUE", /*13*/
	"SHELTER FROM THE STORM", /*14*/
	"SARA", /*15*/
	"THE TIMES THEY ARE A-CHANGIN'", /*16*/
	"HURRICANE", /*17*/
	"ALL ALONG THE WATCHTOWER", /*18*/
	"JUST LIKE A WOMAN", /*19*/
	"MEET ME IN THE MORNING", /*20*/
]
